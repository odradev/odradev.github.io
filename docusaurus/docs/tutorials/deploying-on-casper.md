...
odra-modules = { version = "2.7.2", features = [], default-features = false }
odra-casper-livenet-env = { version = "2.7.2", optional = true }
...
[`InstallConfig`]: https://docs.rs/odra/2.7.2/odra/host/struct.InstallConfig.html
